...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (searchInput && ctx && searchResults) {
        ...
        const selectCard = (card) => {
            ...
            const chartTitle = document.querySelector('.chart-title-placeholder');
            if (chartTitle) {
        ...
        tabBtns.forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                let currentPriceText = statMarket ? ((_a = statMarket.textContent) === null || _a === void 0 ? void 0 : _a.replace('$', '')) || '100' : '100';
